...
#line hidden
#line 57
    testRunner.When("I make a GET request to \'weatherforecast/sevendayminmax\' for the adress: PL Charl" +
                        "es Valentin 59140 Dunkerque, 59140 Dunkerque", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 58
    testRunner.Then("the response status code is \'200\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
                ...
                table3.AddRow(new string[] {
                            ...
                            "24,8"});
#line 59
    testRunner.And("the response with longitude \'52.2\' and latitude \'14.2\'", ((string)(null)), table3, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
