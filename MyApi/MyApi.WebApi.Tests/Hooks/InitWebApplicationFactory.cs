    ...
    private async Task CreateApiTestcontainer()
    {
        _microcksContainer = new MicrocksBuilder()
           .WithImage("quay.io/microcks/microcks-uber:1.10.0")
            .WithMainArtifacts("C:\\Formation\\RestDotNetIntegrationTests\\MyApi\\MyApi.WebApi\\OpenAPIs\\openapi2.yml", "C:\\Formation\\RestDotNetIntegrationTests\\MyApi\\MyApi.WebApi\\OpenAPIs\\geocode.yaml")
            .WithSecondaryArtifacts("C:\\Formation\\RestDotNetIntegrationTests\\MyApi\\MyApi.WebApi.Tests\\Mocks\\OpenMeteo\\openmeteomocks.yml",
            "C:\\Formation\\RestDotNetIntegrationTests\\MyApi\\MyApi.WebApi.Tests\\Mocks\\GeoCode\\geoCodeMocks.yml")
           .Build();
